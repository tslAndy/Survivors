 ...
 * 3. Карты. Касты кругов. Идут пульсацией от игрока. По сути это меч с дочерним объектом (анимация каста). Увеличить скейл дочернего объекта. Накладывает какой-то эффект
