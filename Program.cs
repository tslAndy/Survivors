 ...
 *
 *
 * проблема с логикой при смерти игрока
 * нужно очищать массивы компонентов статус эффектов для врагов
 * можно создать компонент который содержит максимум 8 элементов IDisposable
 * затем система которая будет в отдельном прогоне очищать
 *
 * Конкретное оружие
 *
 *
